...
public class GestionEntrenadoresController {
    ...
    private void bajaLogicaEntrenador() {
        ...
        int idEntrenador = utils.LectorConsola.leerIdConCancelacion(teclado, "Introduce el ID del entrenador a dar de baja");
        if (idEntrenador <= 0) return;
    ...
    private void borradoPermanenteEntrenador() {
        ...
        if (usuarioActual instanceof Admin) {
            ...
            int idEntrenador = utils.LectorConsola.leerIdConCancelacion(teclado, "Introduce el ID del entrenador a ELIMINAR del sistema");
            if (idEntrenador <= 0) return;
